                ...
                <div class="card-body">
					...
					<form method="POST" class="form-signin" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" placeholder="ایمیل" required autofocus>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-12">
								...
								@if(get_option('google_login') == 'enabled')
									<a href="{{ url('google/redirect') }}" class="btn btn-danger btn-block">ادامه با اکانت گوگل</a>
								@endif
