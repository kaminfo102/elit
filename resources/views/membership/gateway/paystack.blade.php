        ...
        <div class="col-md-5">
            <div class="card card-signin my-5">			
                ...
                <div class="card-body" id="extend_membership">
					...
					<h5 class="text-center">'مبلغ قابل پرداخت' : {{ g_decimal_place(convert_currency(get_option('currency','USD'),get_option('paystack_currency','USD'), $amount), currency(get_option('paystack_currency','GHS'))) }}</h5>

					<button type="button" class="btn btn-primary btn-block" onclick="payWithPaystack()"> پرداخت</button>
