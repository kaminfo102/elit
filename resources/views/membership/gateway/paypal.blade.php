            ...
            <div class="card card-signin my-5">			
                ...
                <div class="card-body" id="extend_membership">
					...
					<form action="https://www.zarinpal.com/pg/services/WebGate/wsdl" method="post">
						...
						<input type="hidden" name="amount" value="{{ convert_currency(get_option('currency','IRR'),get_option('paypal_currency','IRR'),$amount) }}">
						<input type="hidden" name="no_shipping" value="0">
						<input type="hidden" name="custom" value="{{ $custom }}">
						<input type="hidden" name="no_note" value="1">
						<input type="hidden" name="currency_code" value="{{ get_option('paypal_currency','IRR') }}">
