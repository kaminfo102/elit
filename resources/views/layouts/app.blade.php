...
<div class="page-container">
			...
			<div class="menu-inner">
				<nav>
					<ul class="metismenu" id="menu">
						<li><a href="{{ url('dashboard') }}"><i class="ti-dashboard"></i> <span>داشبورد</span></a></li>
	...
	<div class="main-content">
		...
		<div class="header-area">
			<div class="row align-items-center">
				...
				<div class="col-md-6 col-sm-3 clearfix">
							...
							@if(Auth::user()->user_type != 'admin')
								<li class="dropdown">
									...
									<div class="dropdown-menu bell-notify-box notify-box">
										<span class="notify-title">{{ 'شما '.' '.Auth::user()->unreadNotifications->count().' '.'اعلان  جدید دارید ' }}</span>
						...
						<li>
							<div class="user-profile">
								...
								<div class="dropdown-menu">
									...
									<a class="dropdown-item" href="{{ url('logout') }}"><i class="ti-power-off text-muted mr-2"></i> خروج</a>
								</div>
							</div>
						</li>
			...
			<div class="row align-items-center py-3">
				<div class="col-sm-12">
					<div class="breadcrumbs-area clearfix">
						<h4 class="page-title float-left">داشبورد</h4>
			...
			@if(has_membership_system() == 'enabled' && $user->user_type == 'user')
				...
				@if( membership_validity() < date('Y-m-d'))
					<div class="alert alert-danger">
						<b class="float-left pt-2">لطفاً برای عضویت در مراحل بعدی ، عضویت خود را پرداخت کنید!</b>
						<a href="{{ url('membership/extend') }}" class="btn btn-primary btn-xs float-right"><b>الان پرداخت کن</b></a>
				...
				@if( $user->company->membership_type == 'trial' && membership_validity() > date('Y-m-d'))
					<div class="alert alert-warning">
						<b>شما در حال حاضر از حساب آزمایشی استفاده می کنید!&emsp;<a href="{{ url('membership/extend') }}" class="btn btn-danger btn-xs">اکنون ارتقا دهید</a></b>
					</div>
				@endif
	...
	<footer>
		<div class="footer-area">
			<p>&copy; {{ jdate('Y').' '.get_option('company_name') }}</p>
		</div>
	</footer>
	<!-- footer area end-->
