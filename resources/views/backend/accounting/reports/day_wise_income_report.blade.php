...
<div class="row">
	<div class="col-12">
		<div class="card">
			...
			<span class="panel-title d-none">گزارش جزئیات درآمد</span>
			...
			<div class="card-body">
				...
				<div class="report-header">
				   <h4>{{ isset($account) ? 'گزارش جزئیات درآمد از'.' '.$acc->account_title : ' گزارش جزئیات درآمد از' }}</h4>
				   <h5>{{ isset($date1) ? jdate($date_format, strtotime($date1)).' '.'تا'.' '.date($date_format, strtotime($date2)) : '-------------  '.'تا'.'  -------------' }}</h5>
				</div>
				...
				<table class="table table-bordered report-table">
					...
					@if(isset($report_data))
					   ...
					   @foreach($report_data as $report) 
						<tr>
						   <td>{{ jdate($date_format, strtotime($report->trans_date)) }}</td>
