...
<div class="row">
	<div class="col-12">
		<div class="card">
			...
			<span class="d-none panel-title">گزارش هزینه ها بر اساس تاریخ</span>
			...
			<div class="card-body">
				...
				<div class="report-header">
				   <h4>{{ isset($account) ? ' گزارش هزینه بر اساس تاریخ'.' '.$acc->account_title : 'گزارش هزینه بر اساس تاریخ' }}</h4>
