...
<div class="row">
	<div class="col-12">
	<div class="card">
	<span class="d-none panel-title">فاکتور جدید</span>
		...
		<div class="row">	
			...
			<div class="col-md-4 d-none" id="contacts">
			  <div class="form-group">
				...
				<label class="control-label">انتخاب کنبد</label>
				...
				<div class="table-responsive">
					...
					<table class="table table-striped">
					   <thead class="thead-light">
					      <tr>
						     <th>
								مبلغ تبدیل شده- <span class="client_currency">{{ base_currency() }}</span>)
...
(function($) {
	...
	$(document).on('click', '.edit-product', function() {
	    ...
	    $("#main_modal .modal-title").html("بروزرسانی محصولات");
	    ...
	    $(document).on('change','#modal-tax_method',function(){
	        if($(this).val() == 'شامل می شود'){
	            $("#modal-unit_cost").val(c_sub_total);
	        }else if($(this).val() == 'شامل نمی شود'){
