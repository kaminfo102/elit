...
<div class="row">
	<div class="col-12">
	<div class="card">
	<span class="d-none panel-title">{{ _lang('فاکتور جدید') }}</span>
		...
		<div class="row">	
			<div class="col-md-4">
			  <div class="form-group">
				<label class="control-label">{{ _lang('شماره فاکتور') }}</label>
			...
			<div class="col-md-4">
			  <div class="form-group">
				<label class="control-label">{{ _lang('مربوط به') }}</label>
				<select class="form-control select2 auto-select" data-selected="{{ isset($_GET['related_to']) ? $_GET['related_to'] : 'contacts' }}" name="related_to" id="related_to">
				   <option value="contacts">{{ _lang('مشتری') }}</option>
				   <option value="projects">{{ _lang('پروژه') }}</option>
				</select>
			  </div>
			</div>
