...
<div class="row">
	<div class="col-12">
	<div class="card">
	<span class="d-none panel-title">پیش فاکتور جدید</span>
		...
		<div class="row">
			...
			<div class="col-md-6">
			  <div class="form-group">
				...
				<select class="form-control select2 auto-select" data-selected="{{ isset($_GET['related_to']) ? $_GET['related_to'] : 'contacts' }}" name="related_to" id="related_to">
                    ...
                    <option value="leads">لــید</option>
				</select>
			  </div>
			</div>
			...
			<div class="col-md-6">
				<div class="form-group select-product-container">
					...
					<label class="control-label">انتخاب کالا/سرویس</label>
				...
				<div class="table-responsive">
					...
					<table class="table table-striped">
					   <thead class="thead-light">
					      <tr>
						     <th>
								مبلغ تبدیل شده (ریال) - <span class="client_currency">{{ base_currency() }}</span>)
