...
<div class="row">
	<div class="col-sm-3">
		<ul class="nav flex-column nav-tabs settings-tab" role="tablist">
		   <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#lead_statuses">وضعیت لــید</a></li>
		   <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#lead_source">منابع لــید</a></li>
		   <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#task_status">وضعیت وظایف</a></li>
		</ul>
	</div>
	...
	<div class="col-sm-9">
		<div class="tab-content">
			<div id="lead_statuses" class="tab-pane active">
				<div class="card">
				  <span class="d-none panel-title">تنظیمات CRM</span>
				  <div class="card-body">
					 <h5 class="card-title"><span>وضعیت های لــید</span>
						<button class="btn btn-primary btn-xs float-right modal-add ajax-modal" data-title="تعریف وضعیت جدید" data-href="{{ route('lead_statuses.create') }}"><i class="ti-plus"></i> جــدید</button>
					 </h5>
								...
								<div class="dropdown">
								  ...
								  <form action="{{ action('LeadStatusController@destroy', $leadstatus['id']) }}" class="ajax-remove" method="post">
									...
									<div class="dropdown-menu" aria-labelledby="lead_status_dropdown">
										<button data-href="{{ action('LeadStatusController@edit', $leadstatus['id']) }}" data-title="بروزرسانی وضعیت" class="dropdown-item dropdown-edit ajax-modal"><i class="mdi mdi-pencil"></i> بروزرسانی</button>
								...
								<td class="text-center">
									<div class="dropdown">
									  ...
									  <form class="ajax-remove" action="" method="post">
										...
										<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
											<a href="" data-title="" class="dropdown-item ajax-modal"><i class="mdi mdi-pencil"></i> ویــرایش</a>
											<a href="" data-title="" class="dropdown-item ajax-modal"><i class="mdi mdi-eye"></i> نمایش</a>
											<button class="dropdown-item" type="submit"><i class="mdi mdi-delete"></i> حــذف</button>
										</div>
									  </form>
