		...
		<div class="card">
			...
			<div class="card-body">
				<ul class="nav nav-tabs">
				  ...
				  <li class="nav-item">
				    <a class="nav-link" data-toggle="tab" href="#task">کار</a>
				  </li>
				  <li class="nav-item">
				    <a class="nav-link" data-toggle="tab" href="#time_sheet">جدول زمانی</a>
				  </li>
				  <li class="nav-item">
				    <a class="nav-link" data-toggle="tab" href="#milestones">زویداد مهم</a>
				  </li>
				  <li class="nav-item">
				    <a class="nav-link" data-toggle="tab" href="#invoices">فاکتورها</a>
				  </li>
				  <li class="nav-item">
				    <a class="nav-link" data-toggle="tab" href="#expense">هزینه</a>
				  </li>
				  <li class="nav-item">
					    ...
					    <div class="row">
					    	<div class="col-lg-6">
							    <table class="table table-bordered">
									...
									<tr><td>مشتری</td><td>{{ $project->client->contact_name }}</td></tr>
									<tr>
										<td>پیشرفت</td>
										<td>
											<div class="progress">
									...
									<tr><td>نوع صورت حساب</td><td>{{ ucwords($project->billing_type) }}</td></tr>
											...
											<div class="seo-fact sbg1">
												<div class="p-4">
													<div class="seofct-icon">
														...
														<span class="float-right">مجموع ساعت کارکرده</span>
													</div>
													<h2 class="text-right">
	                                   		...
	                                   		<div class="card">
												<div class="seo-fact sbg2">
													<div class="p-4">
														<div class="seofct-icon">
														    <i class="ti-user"></i> 
															<span class="float-right">نرخ ثابت</span>
														</div>
							    ...
							    @foreach($timesheets as $timesheet)
								    <tr data-id="row_{{ $timesheet->id }}">
										...
										<td class="text-center">
											<a href="{{ action('TimeSheetController@show', $timesheet['id']) }}" data-title="{{ $timesheet->task->title }}" class="btn btn-primary btn-xs ajax-modal"><i class="mdi mdi-eye"></i> نمایش</a>
										</td>
								    </tr>
							    @endforeach
							</tbody>
						...
						<table id="invoice-table" class="table table-bordered data-table">
							<thead>
							  <tr>
								...
								<th class="text-right">پرداختی</th>
							...
							<tbody>
								@foreach($invoices as $invoice)
									<tr>
										...
										<td class="text-center">
											<a class="byn btn-primary btn-xs" href="{{ url('client/view_invoice/'.md5($invoice->id)) }}" data-title="نمایش فاکتور" data-fullscreen="true"><i class="fas fa-eye"></i> نمایش</a>
										</td>
									 </tr>
								@endforeach
							</tbody>
					    ...
					    <table id="files_table" class="table table-bordered">
							<thead>
							    <tr>
								    ...
								    <th>بارگذاری شده</th>
									<th>فایل</th>
									<th class="text-center">حـــذف</th>
							    </tr>
							</thead>
							<tbody>
							    ...
							    <tr data-id="row_{{ $projectfile->id }}">
									...
									<td class="remove text-center"><a class="ajax-get-remove" href="{{ url('client/projects/delete_file/'.$projectfile->id) }}">حـــذف</a></td>
							    </tr>
							    @endforeach
							    <tr data-id="files_id">
					...
					<div class="tab-pane" id="notes">
						<form method="post" class="ajax-screen-submit" autocomplete="off" action="{{ url('client/projects/create_note') }}">
							...
							<div class="row">
								...
								<div class="col-md-12">
								    <div class="form-group">
									    <button type="submit" class="btn btn-primary">ایجاد یادداشت</button>
								    </div>
								</div>
							</div>			
					    </form>
