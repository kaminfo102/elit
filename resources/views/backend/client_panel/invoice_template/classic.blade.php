...
<div class="row">
	<div class="col-12">
		...
		<div class="btn-group mb-1">
			<a class="btn btn-primary btn-round print" href="#" data-print="invoice-view"> چاپ فاکتور</a>
											...
											<tbody>
												 <tr>
													<td>
														...
														{!! get_company_field($invoice->company_id,'vat_id') != '' ? 'کد مالیاتی'.': '.clean(get_company_field($invoice->company_id,'vat_id')).'<br>' : '' !!}
									...
									<td colspan="2" class="pt-5">
										 <div class="row">
											<div class="invoice-col-6 pt-3">
												 ...
												 {!! $client->vat_id != '' ? 'کد مالیاتی'.': '.clean($client->vat_id).'<br>' : '' !!}
