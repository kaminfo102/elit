...
<head>
	...
	<!--====== Title ======-->
    <title>{{ get_option('website_title','فناوران هوشمند') }}</title>
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarOne">
                                ...
                                @if(Request::is('/'))
                                    <ul class="navbar-nav m-auto">
                                        ...
                                        <li class="nav-item">
                                            <a class="page-scroll" href="{{ url('site/features') }}">ویژگی ها</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="page-scroll" href="{{ url('site/pricing') }}">تعرفه ها</a>
                                        </li>
                                        <li class="nav-item">
                                ...
                                @else 
                                    <ul class="navbar-nav m-auto">
                                        <li class="nav-item">
                                            <a class="page-scroll" href="{{ url('/') }}">خانه</a>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                            <a class="page-scroll" href="{{ url('/') }}#contact">تماس با ما</a>
                                        </li>
                                    </ul>
                                @endif
								...
								<ul class="navbar-nav m-auto auth-nav">
                                    @if(! Auth::check())
                                        <li class="nav-item">
                                            <a class="sing-in-btn" href="{{ url('login') }}">ورود</a>
                                        </li>
										@if(get_option('allow_singup','yes') == 'yes')
											<li class="nav-item">
												<a class="sing-up-btn" href="{{ url('sign_up') }}">ثبت نام</a>
											</li>
										@endif
                                    @else
                                        <li class="nav-item">
                                            <a class="sing-up-btn" href="{{ url('dashboard') }}"><i class='lni lni-dashboard'></i>&nbsp;داشبورد</a>
                                            <a class="sing-in-btn" href="{{ url('logout') }}"><i class='lni lni-exit'></i>&nbsp;خروج</a>
                                        </li>
                                    @endif
                            ...
                            <div class="header-content text-center">
                                ...
                                <ul class="header-btn">
                                    @if(get_option('trial_period') != 0)
										<li><a class="main-btn btn-one" href="{{ Auth::check() ? url('dashboard') : url('sign_up') }}">{{ 'شروع' . ' ' . get_option('trial_period') . ' ' . 'روز رایگان' }}</a></li>
									@else
										<li><a class="main-btn btn-one" href="{{ Auth::check() ? url('dashboard') : url('sign_up') }}">{{ 'شروع کنید' }}</a></li>
									@endif
 
                                    @if(get_option('promo_video_url') != '')
                                        <li><a class="main-btn btn-two video-popup" href="{{ get_option('promo_video_url') }}">ویدیو را ببینید <i class="lni lni-play"></i></a></li>
                                    @endif
                                </ul>
                            </div> <!-- header content -->
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="footer-link">
                            ...
                            <ul>
                                <li><a href="{{ url('site/about') }}">درباره</a></li>
                                <li><a href="{{ url('/') }}#contact">محتوا</a></li>
                            </ul>
                        </div> <!-- footer link -->
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="footer-link">
                            <h6 class="footer-title">تعرفه ها و وبژگی ها</h6>
                            <ul>
                                <li><a href="{{ url('site/pricing') }}">قیمت ها</a></li>
                                <li><a href="{{ url('site/features') }}">ویژگی ها</a></li>
                            </ul>
                        </div> <!-- footer link -->
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-5">
                        <div class="footer-link">
                            <h6 class="footer-title">پشتیبانی</h6>
                            <ul>
                                <li><a href="{{ url('site/faq') }}">پرسش و پاسخ</a></li>
                                <li><a href="{{ url('site/terms_condition') }}">شرایط و دستورالعمل ها</a></li>
                            </ul>
                        </div> <!-- footer link -->
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-7">
                        <div class="footer-newsletter">
                            <h6 class="footer-title">اشتراک خبرنامه</h6>
                            ...
                            <p class="text">برای به روز نگه داشتن خبرنامه هفتگی مشترک شوید. ما هرزنامه ارسال نمی کنیم</p>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="copyright text-center">
                            <p class="text">{!! clean(get_array_option('website_copyright')) !!}</p>
