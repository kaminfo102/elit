...
class LeadStatusController extends Controller
{
    ...
    {	
		...
		if(! $request->ajax()){
           return redirect()->route('lead_statuses.create')->with('success', _lang('با موفقیت ذخیره شد'));
        }else{
		   return response()->json(['result'=>'success','action'=>'store','message'=>_lang('با موفقیت ذخیره شد'),'data'=>$leadstatus, 'table' => '#lead_status_table']);
		}
    ...
    public function update(Request $request, $id)
    {
		...
		if(! $request->ajax()){
           return redirect()->route('lead_statuses.index')->with('success', _lang('با موفقیت بروزرسانی شد'));
        }else{
		   return response()->json(['result'=>'success','action'=>'update', 'message'=>_lang('با موفقیت بروزرسانی شد'),'data'=>$leadstatus, 'table' => '#lead_status_table']);
		}
    ...
    public function destroy(Request $request, $id)
    {
        ...
        if(! $request->ajax()){
           ...
           return response()->json(['result'=>'success', 'message'=>_lang('با موفقیت حذف شد'), 'id'=>$id, 'table' => '#lead_status_table']);
        }
    }
}
