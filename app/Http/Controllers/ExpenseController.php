...
class ExpenseController extends Controller
{
	...
	public function get_table_data(){
		...
		return Datatables::eloquent($transactions)
						...
						->editColumn('expense_type.name', function ($trans) {
							return isset($trans->expense_type->name) ? $trans->expense_type->name : 'انتقال';
						})
						->addColumn('action', function ($trans) {
							if(isset($trans->expense_type->name)){
								...
								.'<a href="'.action('ExpenseController@edit', $trans['id']).'" data-title="'.'بروزرسانی' .'" class="btn btn-warning btn-xs ajax-modal"><i class="ti-pencil"></i></a>&nbsp;'
								.'<a href="'.action('ExpenseController@show', $trans['id']).'" data-title="'.'نمایش' .'" class="btn btn-primary btn-xs ajax-modal"><i class="ti-eye"></i></a>&nbsp;'
								.csrf_field()
    ...
    {	
		...
		if(! $request->ajax()){
           return redirect('expense/create')->with('success', 'با موفقیت ذخیره شد');
        }else{
    ...
    public function update(Request $request, $id)
    {
		...
		if(! $request->ajax()){
           return redirect('expense')->with('success', 'با موفقیت بروزرسانی شد');
        }else{
    ...
    public function destroy($id)
    {
        ...
        $transaction->delete();
        return redirect('expense')->with('success','با موفقیت حذف شد');
    }
}
