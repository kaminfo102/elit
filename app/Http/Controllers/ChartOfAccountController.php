...
class ChartOfAccountController extends Controller
{
    ...
    {	
		...
		if(! $request->ajax()){
           return redirect('chart_of_accounts/create')->with('success', 'با موفقیت ذخیره شد');
        }else{
		   return response()->json(['result'=>'success','action'=>'store','message'=>'با موفقیت ذخیره شد','data'=>$chartofaccount]);
		}
    ...
    public function update(Request $request, $id)
    {
		...
		if(! $request->ajax()){
           return redirect('chart_of_accounts')->with('success', 'با موفقیت بروزرسانی شد');
        }else{
		   return response()->json(['result'=>'success','action'=>'update', 'message'=>'با موفقیت بروزرسانی شد','data'=>$chartofaccount]);
		}
    ...
    public function destroy($id)
    {
        ...
        return redirect('chart_of_accounts')->with('success','با موفقیت حذف شد');
    }
}
