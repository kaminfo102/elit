...
class ProjectMilestoneController extends Controller
{
    ...
    {	
        ...
        create_log('projects', $projectmilestone->project_id, 'ایجاد مرحله مهم از پروژه');
        ...
        if(! $request->ajax()){
           ...
           return response()->json(['result'=>'success','action'=>'store','message'=>'با موفقیت ذخیره شد','data'=>$projectmilestone, 'table' => '#project_milestones_table']);
        }
   ...
   /**
    ...
    public function update(Request $request, $id)
    {
        ...
        create_log('projects', $projectmilestone->project_id, 'بروزرسانی مرحله مهم پروژه');
		...
		if(! $request->ajax()){
		   ...
		   return response()->json(['result'=>'success','action'=>'update', 'message'=>'با موفقیت بروزرسانی شد','data'=>$projectmilestone, 'table' => '#project_milestones_table']);
		}
    ...
    public function destroy(Request $request, $id)
    {
        $projectmilestone = ProjectMilestone::where('id',$id)
                                            ->where('company_id',company_id());
        create_log('projects', $projectmilestone->project_id, 'حذف مرحله مهم پروژه');
        $projectmilestone->delete();

        if(! $request->ajax()){
           return back()->with('success', 'با موفقیت حذف شد');
        }else{
           return response()->json(['result'=>'success', 'message'=>'با موفقیت حذف شد', 'id'=>$id, 'table' => '#project_milestones_table']);
        }
    }
}