...
class UserController extends Controller
{
    ...
    public function index($user_type = 'user')
    {
		...
		$title = $user_type == 'user' ? _lang('لیست کاربران') : _lang('لیست مدیران');
    ...
    {	
		...
		if ($request->hasFile('profile_picture')){
           ...
           Image::make($image)->save(base_path('public/uploads/profile/') .$file_name);
          // Image::make($image)->crop(300, 400)->save(base_path('public/uploads/profile/') .$file_name);
