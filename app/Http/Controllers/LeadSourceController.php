...
class LeadSourceController extends Controller
{
    ...
    {	
        ...
        if(! $request->ajax()){
           ...
           return response()->json(['result'=>'success','action'=>'store','message'=>_lang('با موفقیت ذخیره شد'),'data'=>$leadsource, 'table' => '#lead_source_table']);
        }
    ...
    public function update(Request $request, $id)
    {
		...
		if(! $request->ajax()){
           return back()->with('success', _lang('با موفقیت بروزرسانی شد'));
        }else{
		   return response()->json(['result'=>'success','action'=>'update', 'message'=>_lang('با موفقیت بروزرسانی شد'),'data'=>$leadsource, 'table' => '#lead_source_table']);
		}
    ...
    public function destroy(Request $request, $id)
    {
        ...
        if(! $request->ajax()){
           ...
           return response()->json(['result'=>'success', 'message'=>_lang('با موفقیت حذف شد'), 'id'=>$id, 'table' => '#lead_source_table']);
        }
    }
}