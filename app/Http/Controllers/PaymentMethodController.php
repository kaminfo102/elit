...
class PaymentMethodController extends Controller
{
    ...
    {	
		...
		if(! $request->ajax()){
           return redirect('payment_methods/create')->with('success', _lang('با موفقیت ذخیره شد'));
        }else{
		   return response()->json(['result'=>'success','action'=>'store','message'=>_lang('با موفقیت ذخیره شد'),'data'=>$paymentmethod]);
		}
    ...
    public function update(Request $request, $id)
    {
		...
		if(! $request->ajax()){
           return redirect('payment_methods')->with('success', _lang('با موفقیت بروزرسانی شد'));
        }else{
		   return response()->json(['result'=>'success','action'=>'update', 'message'=>_lang('با موفقیت بروزرسانی شد'),'data'=>$paymentmethod]);
		}
    ...
    public function destroy($id)
    {
        ...
        return redirect('payment_methods')->with('success',_lang('با موفقیت حذف شد'));
    }
}
