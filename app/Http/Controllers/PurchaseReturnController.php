...
class PurchaseReturnController extends Controller
{
    ...
    {	
		...
		if(! $request->ajax()){
           return redirect('purchase_returns/create')->with('success', 'سفارش با موفقیت برگشت داده شد');
        }else{
		   return response()->json(['result'=>'success','action'=>'store','message'=>'سفارش با موفقیت برگشت داده شد','data'=>$purchase]);
		}
    ...
    public function update(Request $request, $id)
    {
		...
		if(! $request->ajax()){
           return redirect('purchase_returns')->with('success', 'با موفقیت بروزرسانی شد');
        }else{
		   return response()->json(['result'=>'success','action'=>'update', 'message'=>'با موفقیت بروزرسانی شد','data'=>$purchase]);
		}
    ...
    public function destroy($id)
    {
        ...
        return redirect('purchase_returns')->with('success','با موفقیت حذف شد');
	}
