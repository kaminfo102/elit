...
class RepeatingIncomeController extends Controller
{
    ...
    public function get_table_data(){
		...
		return Datatables::eloquent($transactions)
						...
						->addColumn('action', function ($trans) {
							...
							.'<a href="'.action('RepeatingIncomeController@edit', $trans['id']).'" data-title="'.'بروزرسانی' .'" class="btn btn-warning btn-xs ajax-modal"><i class="ti-pencil"></i></a>&nbsp;'
							.'<a href="'.action('RepeatingIncomeController@show', $trans['id']).'" data-title="'.'نمایش' .'" class="btn btn-primary btn-xs ajax-modal"><i class="ti-eye"></i></a>&nbsp;'
							.csrf_field()
    ...
    {	
		...
		if(! $request->ajax()){
           return redirect('repeating_income')->with('success', 'با موفقیت ذخیره شد');
        }else{
    ...
    public function update(Request $request, $id)
    {
		...
		if(! $request->ajax()){
           return redirect('repeating_income')->with('success', 'با موفقیت بروزرسانی شد');
        }else{
    ...
    public function destroy($id)
    {
        ...
        return redirect('repeating_income')->with('success','با موفقیت حذف شد');
    }
}
