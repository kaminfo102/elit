...
class TaskController extends Controller
{
	...
	public function get_table_data(Request $request){
		...
		return Datatables::eloquent($tasks)
                        ...
                        ->editColumn('start_date', function ($task) {
                            ...
                            return jdate("$date_format",strtotime($task->start_date));
                        })
                        ->editColumn('end_date', function ($task) {
                            $date_format = get_company_option('date_format','Y-m-d');
                            return jdate("$date_format",strtotime($task->end_date));
                        })
    ...
    {	
        ...
        create_log('projects', $task->project_id, _lang('وظیفه جدید'));
