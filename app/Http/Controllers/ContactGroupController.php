...
class ContactGroupController extends Controller
{
    ...
    {	
		...
		if(! $request->ajax()){
           return redirect('contact_groups/create')->with('success', 'با موفقیت ذخیره شد');
        }else{
		   return response()->json(['result'=>'success','action'=>'store','message'=>'با موفقیت ذخیره شد','data'=>$contactgroup]);
		}
    ...
    public function update(Request $request, $id)
    {
		...
		if(! $request->ajax()){
           return redirect('contact_groups')->with('success', 'با موفقیت بروزرسانی شد');
        }else{
		   return response()->json(['result'=>'success','action'=>'update', 'message'=>'با موفقیت بروزرسانی شد','data'=>$contactgroup]);
		}
    ...
    public function destroy($id)
    {
        ...
        $contactgroup->delete();
        return redirect('contact_groups')->with('success','با موفقیت حذف شد');
    }
}
