...
class CompanyEmailTemplateController extends Controller
{
    ...
    {	
		...
		if(! $request->ajax()){
           return redirect('company_email_template/create')->with('success', 'با موفقیت ذخیره شد');
        }else{
		   return response()->json(['result'=>'success','action'=>'store','message'=>'با موفقیت ذخیره شد','data'=>$companyemailtemplate]);
		}
    ...
    public function update(Request $request, $id)
    {
		...
		if(! $request->ajax()){
           return redirect('company_email_template')->with('success', 'با موفقیت بروزرسانی شد');
        }else{
		   return response()->json(['result'=>'success','action'=>'update', 'message'=>'با موفقیت بروزرسانی شد','data'=>$companyemailtemplate]);
		}
    ...
    public function destroy($id)
    {
        ...
        return redirect('company_email_template')->with('success','با موفقیت حذف شد');
    }
