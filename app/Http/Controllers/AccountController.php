...
class AccountController extends Controller
{
    ...
    {	
		...
		if(! $request->ajax()){
           return redirect('accounts/create')->with('success', 'با موفقیت ذخیره شد');
        }else{
		   return response()->json(['result'=>'success','action'=>'store','message'=>'با موفقیت ذخیره شد','data'=>$account]);
		}
    ...
    public function update(Request $request, $id)
    {
		...
		if(! $request->ajax()){
           return redirect('accounts')->with('success', 'با موفقیت بروزرسانی شد');
        }else{
		   return response()->json(['result'=>'success','action'=>'update', 'message'=>'با موفقیت بروزرسانی شد','data'=>$account]);
		}
    ...
    public function destroy($id)
    {
        ...
        $account->delete();
        return redirect('accounts')->with('success','با موفقیت حذف شد');
    }
